...
export default function story1() {
  return (
    <div id="story1-container" className="mx-auto">
      ...
      <div className="sections">
        <div id="requirements-section" className="section-block">
          ...
          <div className="content">
            <ul>
              ...
              <li>
                A code editor ,{"  "}
                <a href="https://code.visualstudio.com/Download">VS Code </a> is
                prefered
              </li>
        ...
        <div id="Front-Back-end-section" className="section-block">
          ...
          <div className="content">
            <ul className="ml-2">
              {" "}
              <li>
                A front end deals with the "front" of a website or application,
                meaning its design and coding that keep the website working
                properly.{" "}
              </li>
              <li>
                {" "}
                The back end, however, refers to everything on the server-side
                of a website or application, such as important data. Here are
                some more differences between the front end and back end.
              </li>
              <li>
            ...
            <div id="front-end-blocks">
              <h4>HTML :</h4>
              <p>
                Its the structure of the website. Used to define the layout of
                the webpage.
              </p>
              <h4>CSS :</h4>
              <p>
              ...
              <h4>JavaScript(JS) :</h4>
              <p>
                To add fucntionaility to the website, to make components respond
                in a website , like increasing the no.of likes on click of a
                button and displaying the information based on user logged in.
                Unlike CSS and HTML this is a programming language.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="content">
            <div id="block1">
              <ul>
                ...
                <li>JavaScript</li>
                <li>
                  Frameworks : Frameworks and libraries have reusable codes to
                  make the development faster and easier <br />
        ...
        <div id="web-working" className="section-block">
          ...
          <div className="content">
            ...
            <p className="ml-2">
              As the name suggests it locates the resource, the resource could
              be any of the folowing
            </p>
            <ul className="ml-3">
              <li>Image</li>
              <li>Video</li>
            ...
            <p className="ml-3">
              When a url is entered in the browser it requests the resource from
              the computer the url targets to
            </p>
            <p className="ml-3">
              The browser is the <span className="text-light">client</span> and
              the target computer is the{" "}
              <span className="text-light">server</span> .
            </p>
            <div id="client-server-model" className="d-flex flex-row p-5 ml-3">
              ...
              <div id="clientserver-desc" className="ml-3 p-5 text-light">
                <p>
                  ...
                  resource the requests message is based on a protocol(HTTP or
                  HTTPS)
                </p>
                <p>
                  HTTPS is HTTP with encryption and hence is more secure. It
                  encrypts the messages exchanged between the client and server.
                </p>
              </div>
            </div>
            <div id="HTTP-req" className="d-flex flex-row m-2">
              ...
              <div id="req-msg-desc" className="m-2 p-5">
                Client is requesting to <span className="text-light">GET</span>{" "}
                a page <span className="text-light">INDEX.HTML</span> of the
                host <span className="text-light">www.sampleweb.com</span> using{" "}
                <span className="text-light">HTTP version 1.1</span> using the{" "}
                <span className="text-light">client language english-US</span>
              </div>
            </div>
            <div id="HTTP-res" className="d-flex flex-row m-2">
              ...
              <div id="res-msg-desc" className="m-2 p-5">
                ...
                <span className="text-light">status code (200 OK)</span> which
                means successful <br />
                ...
                The requested resource , in this case its a html file . <br />
                This html file may contains links or urls to othr resources such
                as web elements or images , once these resources are requested
                and recieved the browser renders the webpage
              </div>
            </div>
          </div>
        </div>
            ...
            <div id="html-basic-desc">
              ...
              <p className="ml-5">
                ...
                <ul className="ml-2">
                  ...
                  <li>
                    Body contains the layout and all the contents of the website
                    thats visible to the client or user.
                  </li>
                </ul>
                <br />
                ...
                <br />
                Self closing tags can be used instead of such as some frameworks
                dont support tags without a closing tag.
                <br />
        ...
        <div id="html-head" className="section-block">
          ...
          <div className="content d-flex flex-row ">
            <div id="head-desc" className="m-2 mt-4 pr-2 ">
              <ul>
                <li>
                  <span className="text-light">charset</span> : Used to define
                  the character set used , UTF-8 Represents most of the popluar
                  formats
                </li>
                <li>
                ...
                <li>
                  <span className="text-light">description</span> : Description
                  of the webpage is shown in the search result page of a browser
                </li>
              </ul>
            </div>
            <div className="codeblock">
              ...
              initial-scale=1.0"&gt;
              <br />
              &emsp; &lt;meta name="keywords" content="Learning HTML,CSS"&gt;
              <br />
              &emsp; &lt;meta name="description" content="this appears on the
              search engine results as description"&gt;
              <br />
              &emsp; &lt;title&gt;Document&lt;/title&gt;
              <br />
              &lt;/head&gt;
        ...
        <div id="html-text" className="section-block">
          ...
          <div id="html-text-part1">
            ...
            <div className="content d-flex flex-row ">
              ...
              >
                See the Pen{" "}
                <a href="https://codepen.io/richinrix/pen/eYgRwNb">eYgRwNb</a>{" "}
                by Rix (<a href="https://codepen.io/richinrix">@richinrix</a>)
              ...
              <div id="heading-elements-desc" className="ml-2 mt-4 p-2">
                ...
                <li>
                  Heading elemnts should be used based on hierarchial importance
          ...
          <div id="html-text-part2" className="mt-4">
            ...
            <div id="othr-elem-desc">
              ...
              <li>
                <span className="text-light">&lt;strong&gt;</span> is used for
                showing the importance of the text. By default the styling is
                set to bold.
              </li>
              <li>
                <span className="text-light">&lt;em&gt;</span> is emphasizing.
                By default the styling is set to italics.
              </li>
              <li>
                <span className="text-light">&lt;b&gt; and &lt;i&gt;</span> is
                bold and italics but is adivised not to use as HTML should be
                used for making the structure and laying out the template and
                not styling.
              </li>
              <li>
                {" "}
          ...
          <div id="html-text-part3" className="mt-4">
            ...
            <div className="content">
              <p>
                To use symbols that have a default value in HTML as a text we
                use entities.
              </p>
              <p>
            ...
            <div className="content d-flex flex-row">
              ...
              <div className="content ml-3">
                <li>
                  ...
                  <span className="text-light">&lt;a&gt;&lt;/a&gt;</span> is set
                  to blue color and is underlined. The mouse pointer changes
                  whne you hover over it.
                </li>
                <li>
                  You can wrap an image tag with an anchor element to link the
                  image to an hyperlink
                </li>
                <li>
                  You can use "id" in the place of hyperlink to make the page
                  move to the portion of HTML with the id="that_element" on
                  click of the anchor elemnt too. Use : href="#id_name"{" "}
                </li>
                <li>
                  On using href="#" , on click the webpage goes to begining of
                  the webpage{" "}
                </li>
                <li>
                  target="_blank" attribute can be added to make the hyperlink
                  open a new tab
                </li>
                <li>
